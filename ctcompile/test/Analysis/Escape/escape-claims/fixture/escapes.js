...
H.push(primitivePlusNormal);
H.push(primitivePlusSaved);
H.push(primitivePlusUnknown);
...
H.push(primitiveMixedSubNormal);
H.push(primitiveMixedSubSaved);
H.push(primitiveMixedSubUnknown);
...
H.push(primitiveMixedMulNormal);
H.push(primitiveMixedMulSaved);
H.push(primitiveMixedMulUnknown);
...
H.push(primitiveMixedDivNormal);
H.push(primitiveMixedDivSaved);
H.push(primitiveMixedDivUnknown);
...
H.push(primitiveMixedModNormal);
H.push(primitiveMixedModSaved);
H.push(primitiveMixedModUnknown);
...
function storedIntoArrayLiteral() {
    var o = {
        s: 2
    };
    H.push([o]);
...
globalAliasJoin(true);
globalAliasJoin(false);
...
globalAliasLoop(true);
globalAliasLoop(false);
...
function passedAsReceiver() {
    var a = [1];
    a.push(2);
    H.push(a);
} // `a.push` is a call with `a` as receiver
passedAsReceiver();
...
function keepSpreadReceiver() {
    H.push(this);
}

function spreadRetainedReceiver() {
    var receiver = {
        keep: keepSpreadReceiver
    };
    receiver.keep(...[]);
}
...
function transit() {
    ...
    ident(o);
    return 1;
} // analysis: escapes:passed; oracle: confined
transit();
...
function convertedKey() {
    ...
    t[k] = 1;
    return t;
} // the KEY's toString runs
convertedKey();

// --- ACCESSOR DEFINED on the object itself --------------------------------
function accessorDefined() {
    var o = {
        get x() {
            H.push(this);
            return 1;
