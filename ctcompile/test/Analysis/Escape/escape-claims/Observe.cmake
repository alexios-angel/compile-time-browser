  foreach(_line IN LISTS _recording_lines)
    ...
    elseif(_function_name MATCHES "^(canonicalString(Released|Saved|Lookalike|Loaded)|decimalBigInt(Released|Saved|Second|Loaded|Negative)|denseLength(Released|Saved|Loaded|Empty|Indexed|Changed))$" AND _line MATCHES "^site ")
      if(_function_name MATCHES "^denseLength")
        set(_index_family dense_length)
      elseif(_function_name MATCHES "^decimalBigInt")
