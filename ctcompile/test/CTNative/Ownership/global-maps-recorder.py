#!/usr/bin/env python3
"""Execute the owned Map recorders and their lifetimes without the VM."""
...
from native_owned_global_maps.driver_recorder import check_recorders  # noqa: E402

if __name__ == "__main__":
    main(check_recorders)
