...
# compilation-unit.cmake turns into a binary and compares with the
...
foreach(required TRANSLATE OPT SOURCE OUTPUT)
  if(NOT DEFINED ${required})
    message(FATAL_ERROR "pipeline.cmake: -D${required}= is required")
  endif()
endforeach()
...
foreach(outcome IN LISTS outcomes)
  if(NOT outcome EQUAL 0)
    message(FATAL_ERROR "pipeline.cmake: a stage failed (${outcomes})\n${complaints}")
  endif()
endforeach()
...
if(refusals)
  list(JOIN refusals "\n  " refusals)
  message(FATAL_ERROR "pipeline.cmake: ${SOURCE} is not native:\n  ${refusals}")
endif()
