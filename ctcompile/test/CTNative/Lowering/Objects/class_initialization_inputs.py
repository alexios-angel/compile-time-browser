...
OBSERVATIONS = {
    ...
    "class-map-inherited-keyed-holder": (2733, 2733),
    "class-map-record-constructor-keyed-later-number": (207, 207),
    "class-map-record-constructor-keyed-missing": (207, 207),
    "class-map-record-constructor-keyed-computed": (707, 707),
    "class-map-record-constructor-keyed-effect": (107, 107),
    "class-map-record-constructor-keyed-helper-modified-key": (7, 7),
    "class-map-record-constructor-keyed-helper-return-key": (7, 7),
    "class-map-record-constructor-keyed-helper-receiver": (7, 7),
    "class-map-record-constructor-keyed-early": (707, 707),
    "class-map-record-constructor-keyed-owner-escaped": (7, 7),
    "class-map-inherited-keyed-later-number": (207, 207),
    ...
    "class-map-record-captured-helper-distinct": (5757, 5757),
    "class-map-record-captured-helper-escaped": (7, 7),
    "class-map-record-captured-helper-alias-observer": (707, 707),
    "class-map-record-captured-helper-region": (7, 7),
    "class-map-record-captured-helper-read-after-delete": (107, 107),
    "class-map-record-captured-helper-dynamic-key": (7, 7),
    "class-map-record-captured-helper-mixed-payload": (703, 703),
    "class-map-record-captured-helper-returned-class": (7, 7),
    ...
    "class-map-inherited-base-numeric-arguments": (20784, 20784),
    "class-map-inherited-base-numeric-special": (111, 111),
    "class-map-inherited-base-numeric-bitwise": (575, 575),
    "class-map-inherited-base-numeric-later-string": (371, 371),
    "class-map-inherited-base-numeric-coercion-reentry": (735, 735),
    "class-map-inherited-base-numeric-boolean": (722, 722),
    "class-map-inherited-base-numeric-read": (788, 788),
    "class-map-inherited-base-numeric-helper": (799, 799),
    ...
    "class-map-record-alias-snapshot-overwrite-delete": (22124, 22124),
    "class-map-record-alias-snapshot-inherited": (21609, 21609),
    "class-map-record-alias-snapshot-added": (209, 209),
    "class-map-record-alias-snapshot-method-added": (209, 209),
    "class-map-record-alias-snapshot-deleted": (119, 119),
    "class-map-record-alias-snapshot-constructor-publication": (207, 207),
    ...
    "class-map-inherited-chain": (30835580, 30835580),
    "class-map-inherited-method": (808999, 808999),
    "class-map-inherited-mixed-captures": (408, 408),
    "class-map-inherited-early-snapshot": (217, 217),
    "class-map-inherited-reassigned-cell": (9, 9),
    "class-map-inherited-global-replaced": (9, 9),
    "class-map-inherited-prototype-replaced": (9, 9),
    "class-map-inherited-member-replaced": (9, 9),
    "class-map-inherited-unused-ambient": (8, 8),
    "class-map-inherited-stored-receiver": (7, 7),
    "class-map-inherited-helper": (8, 8),
    "class-map-inherited-holder": (8, 8),
    "class-map-inherited-super-method": (8, 8),
    ...
    "inherited-getter-constant": (10, 10),
    "inherited-getter-dependencies": (17, 17),
    "inherited-getter-three-levels": (13, 13),
    "inherited-getter-constructor": (10, 10),
    "inherited-getter-shared-receivers": (91011, 91011),
    "inherited-getter-fresh-empty": (7, 7),
    "inherited-getter-override": (516, 516),
    "inherited-getter-override-dependency": (827, 827),
    "inherited-getter-unused-ambient": (10, 10),
    "inherited-getter-constructor-shadow": (16, 16),
    "inherited-getter-prototype-replaced": (16, 16),
    "inherited-getter-static-method-collision": (9, 9),
    "inherited-getter-static-reads": (733, 733),
...
POSITIVES = GLOBAL_HOLDERS | {
    ...
    "class-map-inherited-base-numeric-arguments",
    "class-map-inherited-base-numeric-special",
    "class-map-inherited-base-numeric-bitwise",
    ...
    "inherited-getter-constructor",
    "inherited-getter-shared-receivers",
    "inherited-getter-fresh-empty",
    "inherited-getter-static-reads",
    "inherited-method-getter",
    "inherited-own-fields-iterate-getter-inherited",
    "override-unused-constructor",
    "inherited-method-unused-constructor",
