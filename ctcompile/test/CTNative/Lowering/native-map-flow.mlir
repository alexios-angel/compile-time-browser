...
// SCHEMA-SAME: ctnative.not_native = "native Map needs supported keys and numeric, object-identity union or acyclic Map values; inferred !ctnative.map<!ctnative.variant<
