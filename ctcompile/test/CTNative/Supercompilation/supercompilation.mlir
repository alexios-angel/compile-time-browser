// RUN: split-file %s %t
// RUN: ctjs-translate --ctbrowser-js-to-ctjs %S/../Fixtures/Optimization/native-supercompilation-fixture.js | ctjs-opt --ctjs-resolve-globals --ctjs-lift-to-scf -o %t/source.mlir
