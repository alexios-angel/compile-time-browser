// RUN: ctjs-translate --ctbrowser-js-to-ctjs %S/../Fixtures/Optimization/partial-closures.js | ctjs-opt --ctjs-resolve-globals --ctjs-lift-to-scf --ctnative-partial-evaluate | FileCheck %s --check-prefix=HEAP
// RUN: ctjs-translate --ctbrowser-js-to-ctjs %S/../Fixtures/Optimization/partial-closures.js | ctjs-opt --ctjs-resolve-globals --ctjs-lift-to-scf --ctnative-partial-evaluate --ctnative-partial-evaluate | FileCheck %s --check-prefix=HEAP
// RUN: ctjs-translate --ctbrowser-js-to-ctjs %S/../Fixtures/Optimization/partial-closures.js | ctjs-opt --ctjs-resolve-globals --ctjs-lift-to-scf --ctnative-binding-time-analysis | FileCheck %s --check-prefix=BTA
// RUN: split-file %s %t
