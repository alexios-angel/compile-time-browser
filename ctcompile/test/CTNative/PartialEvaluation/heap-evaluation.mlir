// RUN: ctjs-translate --ctbrowser-js-to-ctjs %S/../Fixtures/Optimization/partial-evaluation.js | ctjs-opt --ctjs-resolve-globals --ctjs-lift-to-scf --ctnative-partial-evaluate | FileCheck %s --check-prefix=HEAP
// RUN: ctjs-translate --ctbrowser-js-to-ctjs %S/../Fixtures/Optimization/partial-evaluation.js | ctjs-opt --ctjs-resolve-globals --ctjs-lift-to-scf --ctnative-partial-evaluate --ctnative-partial-evaluate | FileCheck %s --check-prefix=REPEAT
// RUN: split-file %s %t
