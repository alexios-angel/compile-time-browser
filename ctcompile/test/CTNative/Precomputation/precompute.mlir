...
// RUN: ctjs-translate --ctbrowser-js-to-ctjs %S/../Fixtures/Optimization/symbolic.js | ctjs-opt --ctjs-resolve-globals --ctjs-lift-to-scf --ctnative-precompute | FileCheck %s --check-prefix=SOURCE
