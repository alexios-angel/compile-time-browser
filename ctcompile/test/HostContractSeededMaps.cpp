...
void checkNullableMapResults(mlir::MLIRContext & context, const std::string & scalar,
        ...
        for (const auto & call : calls) {
            ...
            if (call.function == getter) {
                ...
                complete &=
                    ...
                    argument.alternatives.known &&
                    argument.alternatives.truthy == Alternatives::String &&
                    argument.alternatives.falsy == expectedMask && !argument.alternatives.tag();
    ...
    variant(replaced(normalized, "#ctjs.string<\"owned\">", "#ctjs.string<\"\">"), true,
            "a present empty String is still checked as a possible nullable result");
