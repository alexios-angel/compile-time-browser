...
function(normalise lines out)
  ...
  foreach(line IN LISTS lines)
    string(REGEX REPLACE "^([ \t]*)(auto|double|bool|int32_t|int64_t|float|std::string|ctnative::nullable_scalar|ctnative::nullable_string|ctnative::object_value) ([A-Za-z_0-9]+) = " "\\1T \\3 = " line "${line}")
    ...
    string(REGEX REPLACE "^([ \t]*)ctnative::ctn_env_[A-Za-z_0-9]+ ([A-Za-z_0-9]+) = " "\\1T \\2 = " line "${line}")
    string(REGEX REPLACE "^([ \t]*)std::shared_ptr<ctnative::method_table_[A-Za-z_0-9]+> ([A-Za-z_0-9]+) = " "\\1T \\2 = " line "${line}")
    string(REGEX REPLACE "^([ \t]*)std::shared_ptr<ctnative::identity_object> ([A-Za-z_0-9]+) = " "\\1T \\2 = " line "${line}")
