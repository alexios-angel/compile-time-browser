...
int main(int, char **) {
	...
	static constexpr std::span<const unsigned char> M_A1 =
	    ctbrowser::embed<unsigned char>("examples/assets/models/Alien_1.glb");
	static constexpr std::span<const unsigned char> M_A2 =
	    ctbrowser::embed<unsigned char>("examples/assets/models/Alien_2.glb");
	static constexpr std::span<const unsigned char> M_A3 =
	    ctbrowser::embed<unsigned char>("examples/assets/models/Alien_3.glb");
	static constexpr std::span<const unsigned char> M_MS =
	    ctbrowser::embed<unsigned char>("examples/assets/models/MotherShip.glb");
	static constexpr std::span<const unsigned char> M_P1 =
	    ctbrowser::embed<unsigned char>("examples/assets/models/Player_1.glb");
