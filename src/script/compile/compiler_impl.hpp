...
// than one file. Private to src/script/compile/ - NOT installed, in no file
...
// is policed by tests/lint/api_surface. The precedent is
// src/script/builtins/internal.hpp.
//
