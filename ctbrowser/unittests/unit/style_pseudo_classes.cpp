...
// `:focus-within` is `:focus` on the element or on anything under it, and
// `:focus-visible` is `:focus` here - both derived from the one bit the shell
// sets, so a focus change restyles them together.
