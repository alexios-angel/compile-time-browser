...
// split until a second corpus arrived: `test/` and `unittests/` are SDL-free by an invariant this
...
// Boost.URL and net.hpp for curl.h. `lib/Shell/image/png.cpp` is the only translation
