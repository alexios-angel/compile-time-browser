...
//
// SAME SHAPE AS test/corpus/p5/p5_ratchet.cpp AND test/corpus/phaser/phaser_ratchet.cpp - a
...
[[nodiscard]] std::string babylon_verdict() {
    ...
    // the same reason test/corpus/phaser/phaser_ratchet.cpp measures its language rungs
...
[[nodiscard]] measurement measure() {
    ...
    // document is what test/corpus/phaser/phaser_ratchet.cpp does and it is right there,
