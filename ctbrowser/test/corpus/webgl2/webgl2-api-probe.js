...
// recorded surface in test/corpus/webgl2/webgl2-api.txt is what says which.
...
globalThis.__probes = [
    ...
    ['context', 'is a WebGL2RenderingContext', function (gl) {
        ...
        if (typeof WebGL2RenderingContext === 'undefined') {
            throw 'no WebGL2RenderingContext';
        }
        if (!(gl instanceof WebGL2RenderingContext)) {
            throw 'the context is not one';
        }
        return 'ok';
    }],
    ...
    ['context', 'SHADING_LANGUAGE_VERSION says 3.00', function (gl) {
        ...
        if (v.indexOf('3.00') < 0) {
            throw 'SHADING_LANGUAGE_VERSION is ' + v;
        }
        return v;
    }],
    ...
    ['vao', 'create and bind', function (gl) {
        ...
        if (!a) {
            throw 'createVertexArray gave nothing';
        }
        ...
        if (!bound) {
            throw 'VERTEX_ARRAY_BINDING empty while one was bound';
        }
        if (unbound) {
            throw 'unbinding left one bound';
        }
        return 'ok';
    }],
    ['vao', 'isVertexArray', function (gl) {
        var a = gl.createVertexArray();
        if (gl.isVertexArray(a) !== true) {
            throw 'isVertexArray says no about one it made';
        }
        gl.deleteVertexArray(a);
        if (gl.isVertexArray(a) !== false) {
            throw 'isVertexArray says yes about a deleted one';
        }
        return 'ok';
    }],
    ['vao', 'captures attribute state', function (gl) {
        ...
        gl.deleteVertexArray(a);
        if (captured !== true) {
            throw 'the enable did not survive rebinding';
        }
        if (loose === true) {
            throw 'the enable leaked to the default vertex array';
        }
        return 'ok';
    }],
    ...
    ['instancing', 'vertexAttribDivisor', function (gl) {
        ...
        if (d !== 1) {
            throw 'the divisor read back as ' + d;
        }
        return 'ok';
    }],
    ...
    ['instancing', 'drawElementsInstanced', function (gl) {
        if (typeof gl.drawElementsInstanced !== 'function') {
            throw 'not a function';
        }
        return 'ok';
    }],
    ...
    ['extensions', 'OES_vertex_array_object', function (gl) {
        ...
        if (!ext) {
            throw 'getExtension returned null';
        }
        var a = ext.createVertexArrayOES();
        if (!a) {
            throw 'createVertexArrayOES gave nothing';
        }
    ...
    ['extensions', 'ANGLE_instanced_arrays', function (gl) {
        ...
        if (typeof ext.drawArraysInstancedANGLE !== 'function') {
            throw 'no drawArraysInstancedANGLE';
        }
        if (typeof ext.vertexAttribDivisorANGLE !== 'function') {
            throw 'no vertexAttribDivisorANGLE';
        }
        return 'ok';
    }],
    ['extensions', 'unimplemented ones stay null', function (gl) {
        ...
        if (made_up !== null) {
            throw 'an unimplemented extension answered non-null';
        }
        return 'ok';
    }],
    ...
    ['blocks', 'uniform buffer objects', function (gl) {
        if (typeof gl.bindBufferBase !== 'function') {
            throw 'no bindBufferBase';
        }
        if (typeof gl.getUniformBlockIndex !== 'function') {
            throw 'no getUniformBlockIndex';
        }
        var vs = gl.createShader(gl.VERTEX_SHADER);
        gl.shaderSource(vs, '#version 300 es\n' +
        ...
        if (index !== 0) {
            throw 'getUniformBlockIndex said ' + index;
        }
        ...
        var err = gl.getError();
        if (err !== gl.NO_ERROR) {
            throw 'binding a block raised ' + err;
        }
        return 'works';
    }],
    ['unscoped', '3D textures', function (gl) {
        ...
        if (typeof gl.texStorage3D !== 'function') {
            throw 'no texStorage3D';
        }
        return refuses(gl, function () {
            gl.texImage3D(0, 0, 0, 0, 0, 0, 0, 0, 0, null);
        });
    }],
    ['unscoped', 'multiple render targets', function (gl) {
        if (typeof gl.drawBuffers !== 'function') {
            throw 'no drawBuffers';
        }
        return refuses(gl, function () {
            gl.drawBuffers([]);
        });
    ...
    ['unscoped', 'sampler objects', function (gl) {
        if (typeof gl.createSampler !== 'function') {
            throw 'no createSampler';
        }
        return refuses(gl, function () {
            gl.createSampler();
        });
    ...
    ['unscoped', 'query objects', function (gl) {
        if (typeof gl.createQuery !== 'function') {
            throw 'no createQuery';
        }
        return refuses(gl, function () {
            gl.createQuery();
        });
    ...
    ['unscoped', 'transform feedback', function (gl) {
        if (typeof gl.createTransformFeedback !== 'function') {
            throw 'no createTransformFeedback';
        }
        return refuses(gl, function () {
    ...
    ['unscoped', 'blitFramebuffer', function (gl) {
        if (typeof gl.blitFramebuffer !== 'function') {
            throw 'no blitFramebuffer';
        }
        return 'ok';
    }],
    ['unscoped', 'texStorage2D', function (gl) {
        if (typeof gl.texStorage2D !== 'function') {
            throw 'no texStorage2D';
        }
        return refuses(gl, function () {
            gl.texStorage2D(0, 0, 0, 0, 0);
        });
    }]
];
