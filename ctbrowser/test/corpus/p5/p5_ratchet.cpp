...
//                         act (tools/corpus/ratchet.py p5 ratchet --advance): a test that
...
int main(int argc, char ** argv) {
    ...
    // what tools/corpus/ratchet.py p5 ratchet --bisect drives: one rollup module carved out of
    ...
    if (m.level < r.level) {
        ...
        std::printf("     ADVANCE: level %d -> %d (%s). Run tools/corpus/ratchet.py p5 ratchet "
                    "--advance\n",
        ...
        std::printf("     If this is progress, run tools/corpus/ratchet.py p5 ratchet --advance\n");
        ++ctbrowser_test_failures;
    }
    ...
    if (full.level < r.full_level) {
        ...
        std::printf("     ADVANCE: p5-full level %d -> %d (%s). Run tools/corpus/ratchet.py p5 "
                    "ratchet --advance\n",
