...
globalThis.__probes = [
    ...
    ['color', 'color', function (s) {
        ...
        if (s.red(c) !== 255 || s.green(c) !== 0) {
            throw 'channels: ' + c.toString();
        }
        return c.toString();
    }],
    ['color', 'colorMode', function (s) {
        ...
        if (out < 250) {
            throw 'HSB hue 0 should be red, got red=' + out;
        }
        return 'ok';
    }],
    ['color', 'lerpColor', function (s) {
        const mid = s.lerpColor(s.color(0), s.color(255), 0.5);
        if (s.red(mid) < 100 || s.red(mid) > 155) {
            throw 'midpoint red=' + s.red(mid);
        }
        return 'ok';
    }],
    ...
    ['color', 'fill/noFill', function (s) {
        ...
        s.loadPixels();
        if (s.pixels[0] !== 255) {
            throw 'fill did not take: ' + s.pixels[0];
        }
        s.noFill();
        return 'ok';
    }],
    ...
    ['shape', 'rect', function (s) {
        ...
        if (s.pixels[i] !== 255) {
            throw 'rect did not fill at 4,4';
        }
        return 'ok';
    }],
    ['shape', 'square', function (s) {
        s.square(0, 0, 5);
        return 'ok';
    }],
    ['shape', 'ellipse', function (s) {
        ...
        if (s.pixels[i] !== 255) {
            throw 'ellipse did not fill its centre';
        }
        return 'ok';
    }],
    ['shape', 'circle', function (s) {
        s.circle(10, 10, 6);
        return 'ok';
    }],
    ['shape', 'line', function (s) {
        s.line(0, 0, 10, 10);
        return 'ok';
    }],
    ['shape', 'point', function (s) {
        s.point(3, 3);
        return 'ok';
    }],
    ['shape', 'triangle', function (s) {
        s.triangle(0, 0, 10, 0, 0, 10);
        return 'ok';
    }],
    ['shape', 'quad', function (s) {
        s.quad(0, 0, 10, 0, 10, 10, 0, 10);
        return 'ok';
    }],
    ['shape', 'arc', function (s) {
        s.arc(10, 10, 10, 10, 0, s.PI);
        return 'ok';
    }],
    ['shape', 'beginShape/vertex/endShape', function (s) {
        ...
        if (s.pixels[i] !== 255) {
            throw 'the custom shape did not fill';
        }
        return 'ok';
    }],
    ['shape', 'bezierVertex', function (s) {
        ...
        s.bezierVertex(5, 0);
        s.bezierVertex(10, 5);
        s.bezierVertex(10, 10);
        s.endShape();
        return 'ok';
    }],
    ['shape', 'bezier', function (s) {
        s.bezier(0, 0, 5, 0, 10, 5, 10, 10);
        return 'ok';
    }],
    ...
    ['shape', 'erase/noErase', function (s) {
        s.erase();
        s.noErase();
        return 'ok';
    }],
    ['shape', 'blendMode', function (s) {
        s.blendMode(s.BLEND);
        return 'ok';
    }],
    ...
    ['transform', 'push/pop', function (s) {
        ...
        s.loadPixels();
        if (s.pixels[0] !== 255) {
            throw 'pop() did not restore the origin';
        }
        return 'ok';
    }],
    ['transform', 'translate', function (s) {
        ...
        if (s.pixels[i] !== 255) {
            throw 'translate did not move the rect';
        }
        return 'ok';
    }],
    ['transform', 'rotate', function (s) {
        s.push();
        s.rotate(s.PI / 4);
        s.pop();
        return 'ok';
    }],
    ['transform', 'scale', function (s) {
        s.push();
        s.scale(2, 0.5);
        s.pop();
        return 'ok';
    ...
    ['transform', 'resetMatrix', function (s) {
        s.resetMatrix();
        return 'ok';
    }],
    ['transform', 'applyMatrix', function (s) {
        s.push();
        s.applyMatrix(1, 0, 0, 1, 2, 2);
        s.pop();
        return 'ok';
    }],
    ['transform', 'angleMode', function (s) {
        ...
        if (out < 0.99) {
            throw 'DEGREES not honoured: sin(90)=' + out;
        }
        return 'ok';
    }],
    ...
    ['typography', 'textWidth', function (s) {
        ...
        if (!(s.textWidth('MMMM') > w)) {
            throw 'a longer string is not wider';
        }
        return 'ok';
    }],
    ['typography', 'textAlign', function (s) {
        s.textAlign(s.CENTER, s.CENTER);
        s.textAlign(s.LEFT, s.BASELINE);
        return 'ok';
    }],
    ['typography', 'textSize', function (s) {
        s.textSize(14);
        return '' + s.textSize();
    }],
    ['typography', 'textLeading', function (s) {
        s.textLeading(20);
        return '' + s.textLeading();
    }],
    ['typography', 'textStyle', function (s) {
        s.textStyle(s.BOLD);
        s.textStyle(s.NORMAL);
        return 'ok';
    }],
    ['typography', 'textFont', function (s) {
        s.textFont('serif');
        return 'ok';
    }],
    ...
    ['typography', 'textWrap', function (s) {
        s.textWrap(s.WORD);
        return 'ok';
    }],
    ['typography', 'textBounds', function (s) {
        ...
        if (!b || typeof b.w !== 'number') {
            throw 'no bounds: ' + JSON.stringify(b);
        }
        return 'ok';
    }],
    ...
    ['math', 'constrain', function (s) {
        if (s.constrain(11, 0, 10) !== 10 || s.constrain(-1, 0, 10) !== 0) {
            throw 'constrain';
        }
        return 'ok';
    }],
    ['math', 'lerp', function (s) {
        if (s.lerp(0, 10, 0.5) !== 5) {
            throw 'lerp';
        }
        return 'ok';
    }],
    ['math', 'dist', function (s) {
        if (s.dist(0, 0, 3, 4) !== 5) {
            throw 'dist';
        }
        return 'ok';
    ...
    ['math', 'norm', function (s) {
        if (s.norm(5, 0, 10) !== 0.5) {
            throw 'norm';
        }
        return 'ok';
    }],
    ...
    ['math', 'min/max', function (s) {
        return s.min(1, 2) + ',' + s.max([3, 9, 4]);
    }],
    ...
    ['math', 'random', function (s) {
        ...
        s.randomSeed(1);
        if (s.random() !== a) {
            throw 'randomSeed does not make it repeatable';
        }
        if (a < 0 || a >= 1) {
            throw 'random out of range: ' + a;
        }
        return 'ok';
    }],
    ['math', 'randomGaussian', function (s) {
        return typeof s.randomGaussian();
    }],
    ['math', 'noise', function (s) {
        s.noiseSeed(1);
        const a = s.noise(0.5);
        if (a < 0 || a > 1) {
            throw 'noise out of range: ' + a;
        }
        s.noiseSeed(1);
        if (s.noise(0.5) !== a) {
            throw 'noiseSeed does not make it repeatable';
        }
        return 'ok';
    }],
    ['math', 'noiseDetail', function (s) {
        s.noiseDetail(4, 0.5);
        return 'ok';
    }],
    ...
    ['vector', 'normalize/limit/setMag', function (s) {
        ...
        if (Math.abs(v.mag() - 1) > 0.001) {
            throw 'normalized mag=' + v.mag();
        }
        return 'ok';
    }],
    ['vector', 'dot/cross', function (s) {
        const a = s.createVector(1, 0),
    ...
    ['pixels', 'loadPixels/updatePixels', function (s) {
        ...
        s.loadPixels();
        if (s.pixels[0] !== 255) {
            throw 'updatePixels did not write back';
        }
        return 'ok';
    }],
    ...
    ['pixels', 'pixelDensity', function (s) {
        return '' + s.pixelDensity();
    }],
    ['pixels', 'createImage', function (s) {
        const img = s.createImage(4, 4);
        if (img.width !== 4) {
            throw 'width=' + img.width;
        }
        return 'ok';
    }],
    ['pixels', 'image', function (s) {
        ...
        const px = s.get(1, 1);
        if (px[0] !== 255) {
            throw 'the graphics did not draw: ' + px.join(',');
        }
        return 'ok';
    }],
    ...
    ['structure', 'createCanvas/resizeCanvas', function (s) {
        ...
        if (s.width !== was) {
            throw 'resizeCanvas changed the width';
        }
        return 'ok';
    }],
    ...
    ['structure', 'frameRate/frameCount', function (s) {
        if (typeof s.frameCount !== 'number') {
            throw 'frameCount=' + s.frameCount;
        }
        return typeof s.frameRate();
    }],
    ['structure', 'millis', function (s) {
        return typeof s.millis();
    }],
    ['structure', 'noLoop/loop/isLooping', function (s) {
        s.noLoop();
        if (s.isLooping && s.isLooping()) {
            throw 'still looping after noLoop';
        }
        s.loop();
        s.noLoop();
        return 'ok';
    }],
    ['structure', 'redraw', function (s) {
        s.redraw();
        return 'ok';
    }],
    ...
    ['data', 'splitTokens', function (s) {
        ...
        if (out.length !== 3) {
            throw 'splitTokens=' + JSON.stringify(out);
        }
        return 'ok';
    }],
    ['data', 'shuffle', function (s) {
        ...
        if (out.length !== 4) {
            throw 'shuffle length=' + out.length;
        }
        return 'ok';
    }],
    ...
    ['data', 'hex/unhex', function (s) {
        return s.hex(255, 2);
    }],
    ['data', 'storeItem/getItem/removeItem', function (s) {
        s.storeItem('probe', 5);
        if (s.getItem('probe') !== 5) {
            throw 'getItem=' + s.getItem('probe');
        }
        s.removeItem('probe');
        return 'ok';
    }],
    ...
    ['dom', 'createDiv', function (s) {
        ...
        if (!e || !e.elt || e.elt.tagName.toLowerCase() !== 'div') {
            throw 'not a div';
        }
        e.remove();
        return 'ok';
    ...
    ['dom', 'createButton', function (s) {
        ...
        if (b.elt.tagName.toLowerCase() !== 'button') {
            throw 'not a button';
        }
        b.remove();
        return 'ok';
    ...
    ['dom', 'createSlider', function (s) {
        ...
        if (Number(sl.value()) !== 5) {
            throw 'value=' + sl.value();
        }
        sl.remove();
        return 'ok';
    }],
    ...
    ['dom', 'createCheckbox', function (s) {
        s.createCheckbox('c', true).remove();
        return 'ok';
    }],
    ['dom', 'createSelect', function (s) {
        s.createSelect().remove();
        return 'ok';
    }],
    ['dom', 'createRadio', function (s) {
        s.createRadio().remove();
        return 'ok';
    }],
    ['dom', 'createA', function (s) {
        s.createA('#', 'link').remove();
        return 'ok';
    }],
    ['dom', 'createElement', function (s) {
        s.createElement('h1', 'title').remove();
        return 'ok';
    }],
    ['dom', 'select/selectAll', function (s) {
        if (!s.select('body')) {
            throw 'select("body") found nothing';
        }
        return 'ok';
    }],
    ...
    ['dom', 'element.style/class', function (s) {
        ...
        e.addClass('k');
        if (!e.hasClass('k')) {
            throw 'addClass/hasClass disagree';
        }
        e.removeClass('k');
        e.remove();
        return 'ok';
    ...
    ['dom', 'element.html/attribute', function (s) {
        ...
        if (e.attribute('data-x') !== '1') {
            throw 'attribute round trip';
        }
        e.remove();
        return 'ok';
    }],
    ...
    ['dom', 'element.parent/child', function (s) {
        ...
        parent.remove();
        if (!found) {
            throw 'the child is not among ' + kids.length + ' childNodes';
        }
        return 'ok';
    }],
    ...
    ['events', 'mouseX/mouseY', function (s) {
        if (typeof s.mouseX !== 'number') {
            throw 'mouseX=' + s.mouseX;
        }
        return 'ok';
    }],
    ...
    ['events', 'keyIsDown', function (s) {
        return typeof s.keyIsDown(65);
    }],
    ['events', 'cursor/noCursor', function (s) {
        s.cursor(s.ARROW);
        s.noCursor();
        return 'ok';
    }],
    ...
    // --- accessibility ------------------------------------------------------
    ['a11y', 'describe', function (s) {
        s.describe('a test sketch');
        return 'ok';
    }],
    ['a11y', 'describeElement', function (s) {
        s.describeElement('box', 'a box');
        return 'ok';
    }],
    ['a11y', 'textOutput/gridOutput', function (s) {
        return 'SKIP';
    }],
