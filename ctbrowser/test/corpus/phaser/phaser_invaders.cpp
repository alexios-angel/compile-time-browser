...
//
// A question no rung of test/corpus/phaser/phaser_ratchet.cpp and no probe in
// test/corpus/phaser/phaser_api.cpp asks. The ratchet says the bundle reaches update() and
