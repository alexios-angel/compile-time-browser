...
`ctbrowser/examples/pages/phaser-invaders.html` runs a Space Invaders on it.

A SECOND corpus, because the bugs one library cannot reach are invisible from
inside a corpus of one — see `ctbrowser/docs/script.md` for the five engine bugs this one
