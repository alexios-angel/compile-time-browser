...
ssh devbox 'cd ~/projects/compile-time-browser &&
  CTBROWSER_GL_UBO=1 /tmp/build-angle/test/ctbrowser-test-webgl2_ratchet 2>&1 | rg "^\[ubo\]"'
```
...
**The ratchet records are targets, not scoreboards.** `ctbrowser/test/corpus/webgl2/webgl2-ratchet.txt`
...
```
ctbrowser/lib/Raster/glsl.cpp glsl_eval.cpp glsl_preprocess.cpp glsl_translate.cpp   3598
ctbrowser/lib/Raster/softgl.cpp spirv.cpp                                            1110
ctbrowser/lib/Raster/gles.cpp                                                         666
ctbrowser/lib/Shell/page/webgl.cpp                                                        1496
...
- **`ctbrowser/test/corpus/webgl2/webgl2-ratchet.txt`, `ctbrowser/test/corpus/webgl2/webgl2-api.txt`, `ctbrowser/test/corpus/babylon/babylon-*.txt`,
...
2. **A minimal `raster/gl.hpp`** - the ANGLE device, no software twin. Still no
   EGL or GLES type in a public header; `ctbrowser/test/lint/api_surface` enforces it.
...
Measured, both drivers side by side, by the new `ctbrowser/unittests/unit/gl_basics.cpp`:
