...
ctbrowser/test/corpus/webgl2/webgl2_api.cpp calls as much of WebGL 2's API as can be run headlessly and
reports which calls pass; ctbrowser/test/corpus/webgl2/webgl2-api.txt records them; this drives the
loop.
...
PROBES = ROOT / "ctbrowser/test/corpus/webgl2/webgl2-api-probe.js"
RECORD = ROOT / "ctbrowser/test/corpus/webgl2/webgl2-api.txt"
TEST = ROOT / "build/test/ctbrowser-test-webgl2_api"
...
def do_advance():
    ...
    header = (
        "# Which WebGL 2 probes pass. ctbrowser/test/corpus/webgl2/webgl2_api.cpp measures it; this file\n"
        ...
        "#\n"
        "# The probes themselves are ctbrowser/test/corpus/webgl2/webgl2-api-probe.js, one per line here as\n"
...
def do_coverage():
    ...
    ctbrowser/docs/history/webgl2.md has deliberately NOT committed to and which Babylon.js
    calls in full.
    """
    ...
    for tag in sorted(modules, key=lambda t: -modules[t]):
        note = "  <- deliberately not implemented; see ctbrowser/docs/history/webgl2.md" \
...
def main():
    ...
    ap.add_argument("--advance", action="store_true",
                    help="record the passing probes in ctbrowser/test/corpus/webgl2/webgl2-api.txt")
