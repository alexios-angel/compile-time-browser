...
//
// examples-v2/pages/pong.html is a byte-for-byte copy of the tutorial's final
...
//
// The page path is relative to the repository root, the same convention v1's
...
int main() {
	...
	options.max_fps = 60;
	return ctbrowser::run_app_file("examples-v2/pages/pong.html", options);
}
